<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmStudAttendanceMarkup.aspx.cs" Inherits="School_Dashboard.WebForm10" %>
            ...
            <div class="col-md-6">
                ...
                <table class="w-100">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListStud" runat="server" DataSourceID="SqlDataSource3" DataTextField="StudentName" DataValueField="StudentID" Width="224px">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:SMSConnectionString %>" SelectCommand="SELECT [StudentID], [StudentName] FROM [tbl_Student]"></asp:SqlDataSource>
                        </td>
                    </tr>
                </table>
                <br />
                    ...
                    <table class="w-20" style="width: 32%; height: 31px; color: #000000; background-color: #FFFF99;" border="1">
                        <tr>
                            ...
                            <td class="text-center" style="width: 187px">
                                <asp:RadioButton ID="btnrd_absent" runat="server" Text="Absent" />
                            </td>
                        </tr>
                    </table>
                    <br />
                ...
                <asp:GridView ID="GridViewStudMarkup" runat="server" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
